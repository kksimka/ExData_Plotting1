...
##
plot(cleanData[,1],cleanData$Global_active_power,type="l",ylab = "Global Active Power",xlab="")

##
plot(cleanData[,1],cleanData$Voltage,type="l",ylab = "Voltage",xlab="datetime")
...
##
plot(cleanData[,1],cleanData$Global_reactive_power,type="l",ylab = "Global_reactive_power",xlab="datetime")
###
